      ...
      var i = [],
        ...
        d = function (e) {
          ...
          i.push(e),
            t.push(!1),
            c(s) &&
              (o !== n && o.call(null, { entering: a, exiting: l }),
              (t[i.length - 1] = !0));
        },
        u = function () {
          ...
          for (var g = { entering: a, exiting: l }, f = 0; f < s.length; f++)
            s[f].call(null, g);
...
(window.scwEvents = window.scwEvents || {}),
  (function (e) {
    ...
    (SEMICOLON.initialize = {
      ...
      execPlugin: function (e, i, n) {
        ...
        n
          ? (i.trigger &&
              !scwEvents[i.trigger] &&
              (o.trigger(i.trigger), (scwEvents[i.trigger] = !0)),
            i.execfn && SEMICOLON.initialize.execFunc(i.execfn, window, e),
            i.class && r.addClass(i.class))
          : (i.trigger && !scwEvents[i.trigger]
              ? (t = setInterval(
                  (function e() {
                    return (
                      Function("return " + i.pluginfn)() &&
                        (o.trigger(i.trigger),
                        (scwEvents[i.trigger] = !0),
                        clearInterval(t)),
                      e
                    );
                  })(),
      ...
      goToTop: function () {
        ...
        i || (i = 700),
          ...
          K.off("click").on("click", function () {
            return (
              e("body,html").stop(!0).animate({ scrollTop: 0 }, Number(i), n),
              !1
            );
          });
      },
      goToTopScroll: function () {
        ...
        if (
          (i || (i = 450),
          "true" != e && (r.hasClass("device-sm") || r.hasClass("device-xs")))
        )
          return !0;
        o.scrollTop() > Number(i)
          ? (K.fadeIn(), r.addClass("gototop-active"))
          : (K.fadeOut(), r.removeClass("gototop-active"));
      },
      lightbox: function (e) {
        let i = {
          element: e,
      ...
      topScrollOffset: function () {
        ...
        return (
          ...
          SEMICOLON.isMobile.any()
            ? (e = 40)
            : ((e = u.hasClass("sticky-header")
                ? q.hasClass("dots-menu")
                  ? 100
                  : 144
                : q.hasClass("dots-menu")
                ? 140
                : 184),
              q.length || (e = u.hasClass("sticky-header") ? 100 : 140)),
          e
        );
      },
      ...
      (SEMICOLON.header = {
          ...
          (a = c.outerHeight()),
            c.length > 0 &&
              (e(".header-wrap-clone").length < 1 &&
                c.after('<div class="header-wrap-clone"></div>'),
              (E = e(".header-wrap-clone"))),
            q.length > 0 &&
              (q
                .find("#page-menu-wrap")
                .after('<div class="page-menu-wrap-clone"></div>'),
              (B = e(".page-menu-wrap-clone"))),
        ...
        menuInvert: function (i) {
          let n =
            i ||
            e(".mega-menu-content, .sub-menu-container, .top-links-section");
        ...
        includeOffset: function () {
          ...
          let e = u.outerHeight();
          (u.hasClass("floating-header") || g.hasClass("include-topbar")) &&
            (e += u.offset().top),
            g.css({ "margin-top": -e }),
            ...
            (r.hasClass("device-xl") || r.hasClass("device-lg"))
              ? t.off("click").on("click", function (i) {
                  ...
                  n
                    ...
                    .stop(!0, !0)
                    .slideUp(d),
                    n.parent(o).children(s).stop(!0, !0).slideToggle(d),
                    i.preventDefault();
                })
              : (r.hasClass("side-header") && M.hasClass("on-click")) ||
                r.hasClass("device-md") ||
                r.hasClass("device-sm") ||
                r.hasClass("device-xs")
              ...
              : (r.hasClass("overlay-menu") || r.hasClass("side-header")) &&
                (r.hasClass("device-xl") || r.hasClass("device-lg"))
        ...
        fullWidthMenu: function () {
          ...
          let i = e(
            ...
            .width();
          if (
            (u.find(".container-fullwidth").length > 0 &&
              e(
                ".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content"
              ).css({ width: i }),
            ...
            let i = e(
              ...
              n =
                ...
                (c.outerHeight() - i.parents(".header-row").outerHeight()) +
                "px ); }",
          ...
          (i = o.scrollTop()),
              ...
              (i > e
                ? r.hasClass("side-header") ||
                  ...
                  "true" != I ||
                    ...
                    (i - e > Number(b)
                      ? (u.addClass("sticky-header-shrink"),
                        S &&
                          (j.find("img").css({ height: Number(p) }),
                          SEMICOLON.header.menuItemsSpacing(C)))
                      : (u.removeClass("sticky-header-shrink"),
                        S &&
                          (j.find("img").css({ height: Number(f) }),
            ...
            (r.hasClass("device-xs") ||
              ...
              ("true" == m
                ...
                : SEMICOLON.header.removeStickyness(),
              S &&
                (j.find("img").css({ height: Number(h) }),
        ...
        stickyPageMenu: function (e) {
          if (o.scrollTop() > e)
            if (r.hasClass("device-xl") || r.hasClass("device-lg")) {
              q.filter(":not(.dots-menu,.no-sticky)").addClass(
                "sticky-page-menu"
              );
              let e = c.outerHeight();
              u.length > 0 &&
              ...
              (r.hasClass("device-sm") ||
                r.hasClass("device-xs") ||
                r.hasClass("device-md")) &&
                "true" == q.attr("data-mobile-sticky") &&
                q
        ...
        sidePanel: function () {
          e(".side-panel-trigger")
            ...
            .on("click", function () {
              return (
                r.toggleClass("side-panel-open"),
                r.hasClass("device-touch") &&
                  r.hasClass("side-push-panel") &&
                  r.toggleClass("ohidden"),
                !1
              );
            });
        },
        ...
        logo: function () {
          ...
          (!u.hasClass("dark") && !r.hasClass("dark")) || c.hasClass("not-dark")
            ? (R && e.attr("src") != R && e.attr("src", R),
              T && i.attr("src") != T && i.attr("src", T))
            : (F && e.attr("src") != F && e.attr("src", F),
              _ && i.attr("src") != _ && i.attr("src", _)),
            u.hasClass("sticky-header") &&
              (A && e.attr("src") != A && e.attr("src", A),
              H && i.attr("src") != H && i.attr("src", H)),
            (r.hasClass("device-md") ||
              r.hasClass("device-sm") ||
              r.hasClass("device-xs")) &&
              (D && e.attr("src") != D && e.attr("src", D),
        ...
        stickyMenuClass: function () {
          ...
          if (i > 0) {
            ...
            for (n = 0; n < i; n++)
              "not-dark" == e[n]
                ? (u.removeClass("dark"),
                  c.filter(":not(.not-dark)").addClass("not-dark"))
                : "dark" == e[n]
                ? (c.removeClass("not-dark force-not-dark"),
        ...
        responsiveMenuClass: function () {
          ...
          if (i > 0) {
            ...
            for (n = 0; n < i; n++)
              "not-dark" == e[n]
                ? (u.removeClass("dark"), c.addClass("not-dark"))
                : "dark" == e[n]
                ? (c.removeClass("not-dark force-not-dark"),
                  u.hasClass(e[n]) || u.addClass(e[n]))
                : u.hasClass(e[n]) || u.addClass(e[n]);
          ...
          e(document).on("click", function (t) {
            e(t.target).closest(".top-search-form").length ||
              ...
              e(t.target).closest("#side-panel").length ||
                r.toggleClass("side-panel-open", !1),
      ...
      (SEMICOLON.slider = {
        ...
        sliderDimensions: function () {
          ...
          if (r.hasClass("device-xl") || r.hasClass("device-lg")) {
            ...
            r.hasClass("side-header") && n.width(i),
              r.hasClass("stretched") || ((i = d.outerWidth()), n.width(i));
          } else
            t.css({ height: "" }),
              U.css({ height: "" }),
              n.css({ width: "", height: "" });
        ...
        sliderParallaxOffset: function () {
          ...
          return (
            (r.hasClass("side-header") ||
              u.next(".include-header").length > 0) &&
              (i = 0),
            (e = Y.length > 0 ? Y.outerHeight() + i : i),
            Q.next("#header").length > 0 && (e = 0),
            e
          );
        },
          ...
          (t = window.pageXOffset),
            ...
            SEMICOLON.isMobile.any()
              ? (U.find(".slider-inner").length > 0
                  ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ne),
                    SEMICOLON.slider.sliderParallaxSet(0, 0, ie))
                  : (SEMICOLON.slider.sliderParallaxSet(0, 0, ee),
                    SEMICOLON.slider.sliderParallaxSet(0, 0, ie)),
                U.addClass("slider-parallax-visible").removeClass(
                  ...
                  ? (U.addClass("slider-parallax-visible").removeClass(
                    ...
                    s > n
                      ? U.find(".slider-inner").length > 0
                        ? ((e = -0.4 * (s - n)),
                          (i = -0.15 * (s - n)),
                          SEMICOLON.slider.sliderParallaxSet(0, e, ne),
                          SEMICOLON.slider.sliderParallaxSet(0, i, ie))
                        : ((e = (s - n) / 1.5),
                          (i = (s - n) / 7),
                          SEMICOLON.slider.sliderParallaxSet(0, e, ee),
                          SEMICOLON.slider.sliderParallaxSet(0, i, ie))
                      : U.find(".slider-inner").length > 0
                      ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ne),
                        SEMICOLON.slider.sliderParallaxSet(0, 0, ie))
                      : (SEMICOLON.slider.sliderParallaxSet(0, 0, ee),
                        SEMICOLON.slider.sliderParallaxSet(0, 0, ie)))
                  : U.addClass("slider-parallax-invisible").removeClass(
        ...
        sliderElementsFade: function () {
          ...
          if (
            ...
            let e,
              i = U.outerHeight();
            (e =
              u.hasClass("transparent-header") || r.hasClass("side-header")
                ? 100
                : 0),
        ...
        swiperSliderMenu: function (e) {
          if (
            ((e = void 0 !== e && e),
            r.hasClass("device-xl") ||
              r.hasClass("device-lg") ||
              (u.hasClass("transparent-header-responsive") &&
                !r.hasClass("primary-menu-open")))
          ) {
            ...
            if (i.hasClass("dark")) {
              ...
              r.hasClass("dark")
                ...
                : (e(
                  ...
                  c.removeClass("not-dark"));
            u.hasClass("sticky-header") && SEMICOLON.header.stickyMenuClass(),
              SEMICOLON.header.logo();
          }
        },
      }),
        ...
        extras: function () {
          let i = setInterval(function () {
            "pluginBootstrapReady" in scwEvents &&
              (e().tooltip
                ? e('[data-bs-toggle="tooltip"]').tooltip({ container: "body" })
                : console.log("extras: Bootstrap Tooltip not defined."),
              e().popover
                ? e('[data-bs-toggle="popover"]').popover({ container: "body" })
          ...
          if (
            ...
            let i = e(
              ...
              s = function (e) {
                e
                  ? (r.toggleClass("dark", !0), i.removeClass(n).addClass(t))
                  : (r.toggleClass("dark", !1), i.removeClass(t).addClass(n)),
                  SEMICOLON.header.logo();
              };
            window.matchMedia &&
          ...
          let n = location.hash;
          e(n).length > 0 &&
            e(".one-page-menu").find('[data-href="' + n + '"]').length > 0 &&
            o.scrollTop(0);
        },
      }),
      (SEMICOLON.isMobile = {
      ...
      (SEMICOLON.documentOnReady = {
        ...
        windowscroll: function () {
          u.length > 0 &&
            ((te = u.offset().top),
            c.addClass("position-absolute"),
            (se = c.offset().top),
            c.removeClass("position-absolute"));
      ...
      (SEMICOLON.documentOnLoad = {
        init: function () {
          ...
          let e = setInterval(function () {
            "pluginIsotopeReady" in scwEvents &&
    ...
    let i,
      ...
      O =
        (u.attr("data-mobile-sticky-logo-height") || Number(p),
        u.attr("data-menu-padding") || 39),
      C = u.attr("data-sticky-menu-padding") || 19,
      S = !(
        u.hasClass("header-size-lg") ||
        u.hasClass("header-size-md") ||
        u.hasClass("header-size-sm") ||
        u.hasClass("header-size-custom")
      ),
...
jQuery('[href="media-embeds.html"],[href="gdpr.html"]')
  .parent(".menu-item")
  .addClass("menu-item-important");
jQuery('.menu-link[href="intro.html#section-niche"]')
  .parent(".menu-item")
  .after(
    '<li class="menu-item"><a href="blocks.html" target="_blank" class="menu-link"><div>Blocks</div></a></li>'
  );
...
semicolonweb_loadScriptAsync(
  "https://www.googletagmanager.com/gtag/js?id=G-H74KY38NCR",
  function () {
    function a() {
